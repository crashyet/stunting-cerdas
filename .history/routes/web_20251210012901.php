...
Route::delete('/admin/manajemen-user/{user}', [UserController::class, 'destroy'])
    ...
    // ARTIKEL EDUKASI
Route::post('/admin/edukasi/store', [EdukasiController::class, 'store'])->name('edukasi.store');
Route::prefix('admin')->group(function () {
    Route::get('/edukasi', [App\Http\Controllers\Admin\EdukasiController::class, 'index'])->name('admin.edukasi');
});
