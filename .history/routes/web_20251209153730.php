...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/admin/manajemen-user', [UserController::class, 'index'])->name('admin.manajemen-user');
    Route::delete('/admin/manajemen-user/{id}', [UserController::class, 'destroy'])->name('admin.user.delete');
