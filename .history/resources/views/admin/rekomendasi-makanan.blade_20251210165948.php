...
<div>
    ...
    <textarea name="porsi_disarankan"
              placeholder="Contoh: 2–3 sendok makan per porsi, 2x sehari"
              class="w-full border rounded-md px-3 py-2 h-20 focus:ring-2 focus:ring-green-500"
              required></textarea>
</div>
                    ...
                    <div>
                        ...
                        <textarea name="tips"
                                  class="w-full border rounded-md px-3 py-2 h-24 focus:ring-2 focus:ring-green-500"></textarea>
                    </div>
