<div id="sidebar"
     class="sidebar w-64 bg-white h-screen shadow-xl fixed left-0 top-0 p-6 transition-all duration-300 z-50">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-3 sidebar-text">
            <div class="w-10 h-10 rounded-xl bg-green-100 flex items-center justify-center">
                <i class="fa-solid fa-user text-green-600 text-[18px]"></i>
            </div>

            <h1 class="text-[16px] font-bold text-green-600">Admin</h1>
        </div>

        <button onclick="toggleSidebar()" class="text-gray-600 hover:text-green-600 transition">
            <i class="fa-solid fa-bars text-[18px]"></i>
        </button>
    </div>

    {{-- Garis --}}
    <div class="w-full h-[1px] bg-gray-200 mt-2 mb-4"></div>


    {{-- MENU --}}
    <ul class="space-y-2 text-gray-700 text-[15px]">
    ...
    <div class="absolute bottom-6 left-0 w-full px-4">
        <a href="/"
           class="flex items-center gap-2 p-3 bg-gray-100 hover:bg-gray-200 rounded-xl 
                  text-gray-700 transition sidebar-text text-[15px]">
