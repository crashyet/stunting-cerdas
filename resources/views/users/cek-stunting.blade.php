        ...
        <div class="flex flex-col gap-8">
            ...
            <div class="p-8 bg-white rounded-3xl shadow-sm border animate-[fadeUp_1s_ease-out]">
                ...
                <form class="animate-[fadeUp_1.3s_ease-out]">
                    ...
                    <input type="text" class="w-full px-4 py-3 border rounded-xl mb-4 focus:ring focus:ring-green-200"
                           placeholder="Masukkan nama anak">

                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="text-sm font-medium">Umur (bulan)</label>
                            <input type="number" class="w-full px-4 py-3 border rounded-xl focus:ring focus:ring-green-200"
                                   value="24">
                        </div>
